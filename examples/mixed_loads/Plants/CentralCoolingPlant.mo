...
model CentralCoolingPlant
  ...
  parameter Modelica.SIunits.Temperature TCW_nominal
    ...
    annotation (Dialog(group="Cooling Tower"));
  parameter Modelica.SIunits.TemperatureDifference dT_nominal=6.56
  ...
  parameter Modelica.SIunits.Temperature TMin
    ...
    annotation (Dialog(group="Cooling Tower"));
  parameter Modelica.SIunits.Power PFan_nominal=4999
     "Fan power"
    annotation (Dialog(group="Cooling Tower"));
  // pump parameters
  ...
  parameter Modelica.SIunits.Pressure dpCHWPum_nominal=300000
     "Nominal pressure drop of chilled water pumps"
    annotation (Dialog(group="Pump"));
  parameter Modelica.SIunits.Pressure dpCWPum_nominal=200000
