...
model Floor
  "This is the simulation model of Floor within building teaserID with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=5449.7960825,
    hConInt=2.409090909090909,
    nInt=1,
    RInt={1.2962300011976512e-05},
    CInt={592911106.6632364},
    ...
    nOrientations=4,
    AWin={74.54769655777831, 6.910119334253305, 74.54769655777831, 6.910119334253305},
    ATransparent={74.54769655777831, 6.910119334253305, 74.54769655777831, 6.910119334253305},
    AExt={223.64308967333497, 20.730358002759914, 223.64308967333497, 20.730358002759914}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://mixed_loads/Loads/Resources/Data/teaserID/InternalGains_Floor.txt"),
    columns={2,3,4})
