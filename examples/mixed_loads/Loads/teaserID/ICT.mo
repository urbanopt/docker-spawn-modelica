...
model ICT
  "This is the simulation model of ICT within building teaserID with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=269.51718808000004,
    hConInt=2.2294117647058824,
    nInt=1,
    RInt={0.00020690459898313243},
    CInt={37820354.40789898},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://mixed_loads/Loads/Resources/Data/teaserID/InternalGains_ICT.txt"),
    columns={2,3,4})
