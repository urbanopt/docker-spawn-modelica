...
model Meeting
  "This is the simulation model of Meeting within building teaserID with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=539.0343761600001,
    hConInt=2.2294117647058824,
    nInt=1,
    RInt={0.00010345229949156622},
    CInt={75640708.81579795},
    ...
    nOrientations=4,
    AWin={11.92763144924453, 1.1056190934805288, 11.92763144924453, 1.1056190934805288},
    ATransparent={11.92763144924453, 1.1056190934805288, 11.92763144924453, 1.1056190934805288},
    AExt={35.782894347733595, 3.316857280441586, 35.782894347733595, 3.316857280441586}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://mixed_loads/Loads/Resources/Data/teaserID/InternalGains_Meeting.txt"),
    columns={2,3,4})
