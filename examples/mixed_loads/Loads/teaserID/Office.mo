...
within mixed_loads.Loads.teaserID;
model Office
  "This is the simulation model of Office within building teaserID with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=6737.929702,
    hConInt=2.2294117647058824,
    nInt=1,
    RInt={8.2761839593253e-06},
    CInt={945508860.1974746},
    ...
    nOrientations=4,
    AWin={149.09539311555662, 13.82023866850661, 149.09539311555662, 13.82023866850661},
    ATransparent={149.09539311555662, 13.82023866850661, 149.09539311555662, 13.82023866850661},
    AExt={447.28617934666994, 41.46071600551983, 447.28617934666994, 41.46071600551983}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.4575846758314001, 0.04241532416859994, 0.4575846758314001, 0.04241532416859994},
    withLongwave=true,
    aExt=0.5,
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://mixed_loads/Loads/Resources/Data/teaserID/InternalGains_Office.txt"),
    columns={2,3,4})
