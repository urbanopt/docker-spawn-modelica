...
model Restroom
  "This is the simulation model of Restroom within building teaserID with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=729.28180304,
    hConInt=2.3521739130434787,
    nInt=1,
    RInt={8.932337549076383e-05},
    CInt={86626379.39254574},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://mixed_loads/Loads/Resources/Data/teaserID/InternalGains_Restroom.txt"),
    columns={2,3,4})
