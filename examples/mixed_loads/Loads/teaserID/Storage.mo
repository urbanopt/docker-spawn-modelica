...
model Storage
  "This is the simulation model of Storage within building teaserID with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=2021.3789106000004,
    hConInt=2.2294117647058824,
    nInt=1,
    RInt={2.758727986441767e-05},
    CInt={283652658.05924237},
    ...
    nOrientations=4,
    AWin={44.728617934666985, 4.146071600551982, 44.728617934666985, 4.146071600551982},
    ATransparent={44.728617934666985, 4.146071600551982, 44.728617934666985, 4.146071600551982},
    AExt={134.185853804001, 12.438214801655947, 134.185853804001, 12.438214801655947}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.4575846758314, 0.04241532416859994, 0.4575846758314, 0.04241532416859994},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=4.999999999999999,
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://mixed_loads/Loads/Resources/Data/teaserID/InternalGains_Storage.txt"),
    columns={2,3,4})
