within mixed_loads.Loads.timeSeriesID;
model building
  ...
  package MediumW=Buildings.Media.Water
    "Water medium";
  parameter String filNam="modelica://mixed_loads/Loads/Resources/Data/timeSeriesID/time_series_large_office_2013_5B.mos"
